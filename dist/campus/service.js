...
import {upgradeTimetableSave} from './timetable-upgrade.js';
...
export class SchoolService {
 ...
 static async create({read,wasmBinary,saved}={}){
  ...
  upgradeTimetableSave(restored,content,scenario);
